...
const NANONETS_URL = "https://app.nanonets.com/api/v2/OCR/Model/6ad46e83-fb6d-4bfc-8e6d-714d74a62c16/LabelFile/"
...
const IDScannerView = ({ route, navigation }) => {
  ...
  const takePicture = async () => {
    ...
    setFrontIdPicture(frontIdPicture)

    if (picture) {
      detectOCR(picture)
    } else {
      console.log("Error taking frontIdPicture")
    }
  }
